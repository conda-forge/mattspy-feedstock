...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mattspy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15149&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mattspy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mattspy` can be installed with:

```
conda install mattspy
```

It is possible to list all of the versions of `mattspy` available on your platform with:
